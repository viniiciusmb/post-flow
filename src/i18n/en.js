...
module.exports = {
  ...
  erros: {
    ...
    rotuloDoLinkObrigatorio: "Name the link (e.g. TikTok bio) so you know where the clicks come from.",
    limiteDeLinks: "You already have {max} links. Archive one before creating another.",
    linkNaoEncontrado: "Link not found.",
    linkNaoPodeSerArquivado: "This link can't be archived. Your main link is always available.",
    ...
    modoPartesInvalido: "Invalid part-splitting mode.",
    quantidadePartesInvalida: "Invalid number of parts (1 to 30).",
    duracaoParteInvalida: "Invalid length for each part (1 to 10 minutes).",
    ...
    fonteInvalida: "Invalid font.",
    corInvalida: "Invalid color.",
