        ...
        blocos: [
          {
            ...
            itens: [
              ...
              'Los pagos los procesa Stripe. No guardamos los datos de tu tarjeta.',
            ],
          },
        ],
      },
        ...
        blocos: [
          {
            ...
            linhas: [
              ...
              ['El archivo del vídeo descargado', 'Cortar y subtitular', 'Se borra en cuanto los clips están listos'],
              [
                'Transcripción del audio',
                'La IA la usa para elegir los fragmentos y para generar el texto',
                'Mientras el vídeo exista en tu panel',
              ],
              [
                'Los archivos de los clips terminados',
                'Publicar en TikTok y exportar a tu Drive',
                'Se borran automáticamente tras la publicación (7 días por defecto, ajustable por ti)',
              ],
              [
              ...
              [
                ...
                '<strong>Nunca pasan por nuestros servidores</strong>. Se quedan solo con Stripe',
              ],
            ],
          },
        ],
        ...
        blocos: [
          ...
          },
          {
            ...
            itens: [
              ...
              '<strong>Stripe</strong>. Procesa los pagos y guarda los datos de la tarjeta.',
        ...
        blocos: [
          { tipo: 'p', texto: 'Al recibir una solicitud de eliminación, borramos:' },
          {
            ...
            itens: [
              ...
              'El historial de créditos y el vínculo con Stripe.',
            ],
          },
          {
            tipo: 'p',
