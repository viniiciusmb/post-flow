        ...
        blocos: [
          {
            ...
            itens: [
              ...
              'Payments are processed by <strong>Asaas</strong> (subscription and one-off credit, by card or PIX). <strong>We never store your card details</strong> — they are typed on Asaas\'s own screen and never pass through our servers.',
            ],
          },
        ],
      },
        ...
        blocos: [
          {
            ...
            linhas: [
              ...
              [
                ...
                'Cutting and captioning. When two customers follow the same YouTube channel, the video is downloaded once and the file serves both — it is identical public content, and this cuts bandwidth use',
                'Deleted as soon as nobody needs it any more, and within 48 hours at most',
              ],
              [
                'Audio transcript',
                'The AI uses it to pick segments and to write the caption. The transcript of a public YouTube video is stored and reused if another customer requests the same video — it is the same spoken text, and this avoids transcribing it again',
                'Up to 90 days, even if you delete the video from your dashboard',
              ],
              [
                'The finished clip files',
                'Publishing to TikTok and exporting to your Drive',
                'Deleted automatically 3 days after publication on TikTok',
              ],
              [
              ...
              [
                'Payment data (card)',
                'Subscription and one-off credit billing',
                '<strong>Never passes through our servers</strong>. It is typed on Asaas\'s screen and stays with them only',
              ],
              [
                'Tax ID (CPF or CNPJ)',
        ...
        blocos: [
          { tipo: 'p', texto: 'On receiving a deletion request, we delete:' },
          {
            ...
            itens: [
              ...
              'Credit history and the links to Asaas and Stripe.',
            ],
          },
          {
            tipo: 'p',
